...
int main(int argc, char* argv[])
{
	...
	effect_srd(bitmapData, bitmapInfoHeader.biWidth, bitmapInfoHeader.biHeight);
	...
	effect_Mean(bitmapData, bitmapInfoHeader.biWidth, bitmapInfoHeader.biHeight);
		err = SaveBitmapFile("out_mean_bw.bmp", &bitmapFileHeader,
